...
import { MenupageEntityResponse, MenupageEntityResponseCollection, MenupageFiltersInput } from './menuPage.type'
...
export class MenuPageResolver {
    ...
    public async menupages(
        ...
        return (await this.strapiGqlSdk.menuPages({ filters, pagination, sort, publicationState, locale })).menupages
    }
}
