import { recordMetaArchiveT, recordMetaPublicationT } from 'locales/locales'
import { ArchivesRecordZoomLevel3Type, PublicationRecordZoomLevel3Type } from 'src/generated/graphql'
