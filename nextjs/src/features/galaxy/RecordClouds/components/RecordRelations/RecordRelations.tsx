...
const RecoredRelations = (props: RecoredRelationsProps) => {
  ...
  function getRelatedItemsTranslation(relation: ParentRelation) {
    ...
    if (relation.type === EntityNames.Archives)
      return t('relatedArchive', { count: relation.showing })
    if (relation.type === EntityNames.Stories)
      return t('relatedStories', { count: relation.showing })
