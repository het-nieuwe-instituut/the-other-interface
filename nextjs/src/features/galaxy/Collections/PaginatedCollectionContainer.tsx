...
import { ZoomLevel4ParentType, ZoomLevel4Type } from 'src/generated/graphql'
...
export const PaginatedCollection: React.FunctionComponent<PaginatsedProps> = props => {
  ...
  const total =
    zoom4?.zoomLevel4?.total && zoom4?.zoomLevel4?.total >= 28
      ? Math.ceil(zoom4?.zoomLevel4?.total / 28)
      : 1
                      ...
                      {item.title && (
                        ...
                        >
                          {(item as ZoomLevel4Type)?.pidWorkURI && (
                            ...
                            <Image
                              src={(item as ZoomLevel4Type)?.pidWorkURI ?? 'broken'}
                              width={'48px'}
                              height={'35px'}
                              alt={''}
