...
export const aQuery = (overrides?: Partial<Query>, _relationshipsToOmit: Array<string> = []): Query => {
    ...
    return {
        ...
        storyHover: overrides && overrides.hasOwnProperty('storyHover') ? overrides.storyHover! : relationshipsToOmit.includes('StoryHoverType') ? {} as StoryHoverType : aStoryHoverType({}, relationshipsToOmit),
