...
export const aComponentModulesCollectionRelation = (overrides?: Partial<ComponentModulesCollectionRelation>, _relationshipsToOmit: Array<string> = []): ComponentModulesCollectionRelation => {
    ...
    return {
        ...
        id: overrides && overrides.hasOwnProperty('id') ? overrides.id! : 'acfde8b6-82f1-4fcc-9426-72165aa72eb6',
        story: overrides && overrides.hasOwnProperty('story') ? overrides.story! : relationshipsToOmit.includes('StoryEntityResponse') ? {} as StoryEntityResponse : aStoryEntityResponse({}, relationshipsToOmit),
        triplyRecord: overrides && overrides.hasOwnProperty('triplyRecord') ? overrides.triplyRecord! : relationshipsToOmit.includes('TriplyRecordEntityResponse') ? {} as TriplyRecordEntityResponse : aTriplyRecordEntityResponse({}, relationshipsToOmit),
    };
};
...
export const aComponentModulesImage = (overrides?: Partial<ComponentModulesImage>, _relationshipsToOmit: Array<string> = []): ComponentModulesImage => {
    ...
    return {
        ...
        captionRelation: overrides && overrides.hasOwnProperty('captionRelation') ? overrides.captionRelation! : relationshipsToOmit.includes('ComponentModulesCollectionRelation') ? {} as ComponentModulesCollectionRelation : aComponentModulesCollectionRelation({}, relationshipsToOmit),
        ...
        imageRelation: overrides && overrides.hasOwnProperty('imageRelation') ? overrides.imageRelation! : relationshipsToOmit.includes('ComponentModulesCollectionRelation') ? {} as ComponentModulesCollectionRelation : aComponentModulesCollectionRelation({}, relationshipsToOmit),
    };
};
...
export const anObjectMakerType = (overrides?: Partial<ObjectMakerType>, _relationshipsToOmit: Array<string> = []): ObjectMakerType => {
    ...
    return {
        id: overrides && overrides.hasOwnProperty('id') ? overrides.id! : 'fe201394-d3b5-4eb4-a1e1-9967439577b4',
...
export const anObjectMaterialType = (overrides?: Partial<ObjectMaterialType>, _relationshipsToOmit: Array<string> = []): ObjectMaterialType => {
    ...
    return {
        id: overrides && overrides.hasOwnProperty('id') ? overrides.id! : '6b548907-b604-4c9f-9d20-00fca965472a',
...
export const anObjectTechniqueType = (overrides?: Partial<ObjectTechniqueType>, _relationshipsToOmit: Array<string> = []): ObjectTechniqueType => {
    ...
    return {
        id: overrides && overrides.hasOwnProperty('id') ? overrides.id! : '613fbcc5-a2b0-4618-aa20-6c02e7972fae',
