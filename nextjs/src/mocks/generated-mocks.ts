...
export const aStoryFiltersInput = (overrides?: Partial<StoryFiltersInput>, _relationshipsToOmit: Array<string> = []): StoryFiltersInput => {
    ...
    return {
        ...
        preface: overrides && overrides.hasOwnProperty('preface') ? overrides.preface! : relationshipsToOmit.includes('StringFilterInput') ? {} as StringFilterInput : aStringFilterInput({}, relationshipsToOmit),
